...
class IPCDll
{
	typedef IIPCApi* (__stdcall *_FnCreateIPCObject)();
	typedef void (__stdcall *_FnDestroyIPCObject)(void*);

	typedef IIPCApplication* (__stdcall *_FnCreateIPCApplication)(IIPCApi* obj);
	typedef void (__stdcall *_FnDestroyIPCApplication)(IIPCApplication*);
